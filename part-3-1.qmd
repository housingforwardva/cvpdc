...
dec_2020 <- c("2020", 261593) # 2020 Decennial Census
...
ggplot(cv_tenure,
  ...
  labs(title = "Household tenure",
       subtitle = "Percent of occupied households")
...
ggplot(cv_age,
       aes(x = year, 
           y = pct,
           fill = age))  +
  facet_grid(tenure ~ age) +
  geom_col(position = "dodge") +
  theme_hfv() +
  scale_fill_hfv() +
  scale_y_continuous(labels = percent_format()) +
  theme(axis.text.x = element_text(angle = 90, vjust = .2)) +
  labs(title = "Households by age",
       subtitle = "Percent of total occupied households")
