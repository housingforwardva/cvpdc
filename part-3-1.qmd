...
# Eric says this was not in the sandbox repo to review as far as he could see
...
# Eric is iffy on my methods to reach the above - needs to be checked
...
# Eric's above plots should be reviewed - I used the vacancy status of for rent/rented and for sale/sold to create vacancy rates for those; And then created a different plot for just seasonal/other vacant
...
# Eric ouldn't get the ggplot map to work because I can't figure out the limit bounds on the x and y axis. 

# Age of manufactured homes -- use PUMS to show pre/post-1976 (low priority)

# Eric did not do the above
...
# Eric doesn't know what ACS table this is??
...
# cv_hmda <- read_csv("data/hmda_va.csv") |> 
