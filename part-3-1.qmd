...
# Add selected wage stats (data only for Lynchburg MSA)
# Recreate https://hdadvisors.github.io/rrh-framework/part-1-3.html#wages
...
# Age of manufactured homes -- use PUMS to show pre/post-1976 (low priority)
...
cv_cbps_plot <- ggplot(cv_cbps,
  ...
  labs(title = "New residential building permits by type",
       subtitle = "Annual permits issues from 2000 through November 2022",
