...
This report assesses housing-related policies and programs currently operating within the Central Virginia Planning District. These include efforts to expand housing supply through land use reform, improve the quality and condition of existing homes, deliver federally-funded housing assistance, prevent homelessness, and other activities.
...
-   [**Continue**]{style="color: #259591;font-size: 120%"}: This effort should continue as designed without significant changes, and should scale up to further address needs when opportunities arise.
-   [**Reevaluate**]{style="color: #E0592A;font-size: 120%"}: This effort may not be working as intended, and should be reexamined for potential changes.
-   [**Stop**]{style="color: #B1005F;font-size: 120%"}: This effort has clear drawbacks and should be ended to no longer be counterproductive to the region's housing goals.
...
[**Continue.**]{style="color: #259591;font-size: 150%"} The city should maintain its current regulatory approach to promote new attainable homeownership opportunities, and use the upcoming comprehensive plan update to leverage infrastructure development opportunities to support its infill goals
...
[**Reevaluate.**]{style="color: #E0592A;font-size: 150%"} Counties have the opportunity to reexamine their zoning codes to not just build on current successes, but also consider significant changes to better meet post-COVID housing demand.
...
[**Reevaluate.**]{style="color: #E0592A;font-size: 150%"} If localities want to promote additional ADU supply, they can explore aligning ordinances with state and national best practices, and creating resources to proactively help homeowners with ADU development.
...
[**Reevaluate.**]{style="color: #E0592A;font-size: 150%"} LRHA could expand Section 8 HCV Program to higher opportunity areas and continue ongoing landlord recruitment and education programs. Regionally, new collaborations around voucher administration could be explored to address challenges in the counties.
...
[**Continue**]{style="color: #259591;font-size: 150%"} / [**Reevaluate.**]{style="color: #E0592A;font-size: 150%"} Public housing authorities should continue to review and assess the public housing units to meet the Section 504 requirements. PHAs can also continue to monitor and explore HUD programs that can be used to reposition public housing communities for revitalization/redevelopment.
...
[**Continue.**]{style="color: #259591;font-size: 150%"} As new homes are built in the region, homebuyer readiness programs and financial assistance are vital tools that help first time homebuyers and low-income buyers compete in a crowded market. Assistance should continue and further funding considered to make a larger impact in the region.
...
[**Continue**]{style="color: #259591;font-size: 150%"} / [**Reevaluate.**]{style="color: #E0592A;font-size: 150%"} The region should continue to explore low-cost or subsidized transportation options where feasible and consider how new housing and services can be clustered in the region.
...
[**Continue.**]{style="color: #259591;font-size: 150%"} Coordinated care and funding to prevent eviction in the region should continue to be prioritized as a way to avoid long-lasting impacts on families and to prevent the public costs of eviction (including emergency healthcare, shelter, etc.). Efforts to improve tracking of informal evictions is recommended.
...
[**Continue**]{style="color: #259591;font-size: 150%"} Low recidivism rates are evidence of the success of the housing-first model. The CVCoC should continue to tackle the issue of homelessness, potentially adding new shelters or transit opportunities in areas of the region that are farther away from existing resources.
...
[**Reevaluate.**]{style="color: #E0592A;font-size: 150%"} The region should explore mechanisms to reduce up-front utility costs to pave the way for the creation and preservation of new dedicated affordable housing.
...
[**Continue**]{style="color: #259591;font-size: 150%"} Localities should continue to leverage current state broadband initiatives to expand access and affordability of high-speed internet for residents.
...
[**Reevaluate.**]{style="color: #E0592A;font-size: 150%"} There are opportunities to make STR regulations across the region more uniform and more responsive to increasing concerns about the potential negative impacts of STR on housing supply.
...
[**Continue**]{style="color: #259591;font-size: 150%"} New collaborations can be pursued in other localities, as well as at the regional level.

## Takeaways and next steps

Current efforts in the CVPDC offer a solid base for future initiatives. Policy recommendations to be crafted in the next report will build off this research and analysis and focus on how more targeted solutions may help address the housing challenges in the region.
