...
local_str_plot <- ggplot(local_str,
  ...
  labs(title = "Lynchburg's share of regional housing stock",
      subtitle = "Percent of all occupied homes in region within Lynchburg by tenure and type in 2021",
...
cv_cb9_plot <- ggplot(cv_cb9,
       aes(x = year, 
           y = pct,
           fill = str_wrap(race, width = 16),
           data_id = pct,
           tooltip = percent_format()(pct))) +
  geom_col(position = "stack") +
  geom_col_interactive(size = 2) +
  facet_wrap(~race, scales = "free_x", labeller = label_wrap_gen(16)) +
  scale_y_continuous(labels = percent_format()) +
  scale_fill_hfv() +
  theme_hfv() +
  add_zero_line("y") +
