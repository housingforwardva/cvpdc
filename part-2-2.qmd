...
#| fig-cap: "Change in subfamilies living with others"
...
#| fig-cap: "Cumulative change in young adults living with parents"
...
local_achild_plot <- ggplot(local_achild,
  ...
  scale_fill_hfv() +
  facet_wrap(~county, nrow = 1) +
  labs(title = "Cumulative change in young adults living with parents",
...
local_str_plot <- ggplot(local_str,
  ...
  geom_col(position = "stack") +
  geom_col_interactive() +
  facet_grid(tenure ~ county, switch = "y", labeller = label_wrap_gen(width = 12)) +
  theme_hfv() +
  add_zero_line("y") +
  scale_fill_hfv() + 
  scale_y_continuous(labels = label_percent()) +
