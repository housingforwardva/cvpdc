...
```{r}
#| label: fig-localproj
#| fig-cap: "Projected population growth 2030 to 2050 by county"
...
local_proj_plot <- ggplot(projections,
       aes(x = reorder(NAME, -Difference),
           ...
           fill = NAME,
           data_id = Difference,
           tooltip = label_number(big.mark = ",",
                                  style_positive = "plus",
                                  style_negative = "minus")(Difference))) +
  geom_col() +
  geom_col_interactive() +
  theme_hfv() +
  scale_fill_hfv() +
...
```{r}
#| label: fig-localage
#| fig-cap: "Local percent of households by age and tenure"
