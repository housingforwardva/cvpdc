...
ggplot(sales, 
  ...
  geom_point_interactive(
    aes(data_id = med_price,
        tooltip = dollar_format()(med_price)),
    size = 2) + 
  geom_text(aes(label = dollar(med_price), hjust = ifelse(period == "2023 Q2", -0.25, 1.25))) +
  coord_flip() +
  theme_hfv() +
  scale_y_continuous(labels = dollar_format(), limits = c(100000, 400000)) +
